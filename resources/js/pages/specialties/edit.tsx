...
export default function Edit({ specialty }: { specialty: Especialty }) {
    const { data, setData, patch, processing, errors } = useForm<Required<Especialty>>({
        name: specialty.name,
        can_attend: specialty.can_attend ?? 10,
    });
                        ...
                        <div className="items-center p-6">
                            <div className="mb-6 sm:flex sm:items-center">
                                <div className="sm:flex-auto">
                                    ...
                                    <p className="mt-2 text-sm">Atualização da especialidade {specialty.name}.</p>
                                </div>
                            </div>
